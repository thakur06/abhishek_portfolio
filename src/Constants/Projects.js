...
const project_portfolio={
    name:"Portfolio",
    description:"A 3d portfolio provides seamless user experience with various functionalities using Accertinity UI components",
    url:"https://github.com/thakur06/portfolio_3d",
    stack:["#react JS","#email JS" , "#accernity UI"],
    imgSrc:Portfolio,
    color:[Math.floor(Math.random() * color.length),Math.floor(Math.random() * color.length),Math.floor(Math.random() * color.length)]
}
